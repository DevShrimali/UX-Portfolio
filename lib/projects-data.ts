export type ProjectCategory = "ui-ux" | "graphic" | "branding" | "logo" | "brochure" | "website" | "github" | "behance" | "hobby"
...
export const projects: Project[] = [
  ...
  {
    id: "crypto-coin-app",
    title: "Crypto App: Trade with Confidence",
    category: ["ui-ux", "behance"],
    tags: ["Fintech", "Crypto", "Mobile App", "UI Kit"],
    description: "A comprehensive UI Kit for a cryptocurrency exchange application. Designed to make buying and selling crypto assets intuitive and secure for everyone, from beginners to expert traders. The app features real-time market data, clear portfolio tracking, and seamless transaction flows.",
    shortDescription: "Buying Bitcoin shouldn't be scary! Ready to trade with confidence?",
    image: "/crypto-app/cover.png",
    bgColor: "bg-[#0F172A]",
    behanceUrl: "https://www.behance.net/gallery/240563559/Crypto-Coin-App-UI-Kit",
    challenge: "Cryptocurrency trading processes are often complex and intimidating for new users. The challenge was to design a platform that simplifies buying and selling while providing the robust tools experienced traders expect.",
    solution: "We created a clean, dark-themed interface that prioritizes data visibility and portfolio management. The 'Buy & Sell' flow was broken down into simple steps, and charts were optimized for readability on mobile devices.",
    results: [
      "Simplified Buy/Sell Flow",
      "Enhanced Portfolio Visibility",
      "Trust-Building UI Design",
  ...
  {
    id: "3d-block-builder",
    title: "3D Block Builder",
    category: ["hobby", "website"],
    tags: ["Three.js", "3D", "Interactive"],
    description: "An interactive web-based 3D block building environment where users can create and manipulate structures in three-dimensional space.",
    shortDescription: "Build your own 3D world right in the browser! Want to start stacking?",
    image: "/placeholder.svg",
    bgColor: "bg-[#1e1e1e]",
    websiteUrl: "https://3d-block-builder.netlify.app/",
    challenge: "To create a performant and intuitive 3D manipulation tool in the browser.",
    solution: "Implemented using modern web 3D libraries to ensure smooth rendering and easy controls.",
  ...
  },
  {
    ...
    description: "A smart task management application that utilizes AI to help users organize, prioritize, and manage their daily tasks more effectively.",
    shortDescription: "A todo list that helps you think! Ready to get organized with AI?",
    image: "/placeholder.svg",
    bgColor: "bg-[#0f172a]",
    websiteUrl: "https://ai-based-todo-app.netlify.app/",
    challenge: "To enhance a standard todo app with intelligent features.",
    solution: "Integrated AI features to suggest priorities and categorize tasks automatically.",
    tools: ["React", "AI API"],
    timeline: "Hobby",
    role: "Developer",
  },
  {
    id: "dynamic-menu",
    title: "Dynamic Menu V",
    category: ["hobby", "website"],
    tags: ["UI Interaction", "Animation", "CSS"],
    description: "An experimental navigation menu featuring fluid animations and dynamic interactions, showcasing modern CSS and JavaScript capabilities.",
    shortDescription: "A menu that feels alive! Want to see smooth interactions?",
    image: "/placeholder.svg",
    bgColor: "bg-[#111]",
    websiteUrl: "https://dynamic-menu-v.netlify.app/",
    challenge: "To create a menu that is both functional and playfully interactive.",
    solution: "Used advanced CSS transitions and JS event handling to create fluid movement.",
  ...
  },
  {
    ...
    category: ["hobby", "github"],
    tags: ["Utility", "Video", "API"],
    description: "A functional utility tool that enables Picture-in-Picture mode for video content, allowing users to watch videos while multitasking across other windows.",
    shortDescription: "Watch videos while you work! Want to enable multitasking?",
    image: "/placeholder.svg",
    bgColor: "bg-[#252525]",
    websiteUrl: "https://devshrimali.github.io/Picture-in-Picture/",
    githubUrl: "https://github.com/DevShrimali/Picture-in-Picture",
    challenge: "To leverage the Picture-in-Picture Web API for a seamless user experience.",
    solution: "Created a simple interface to toggle PiP mode for media streams.",
    tools: ["JavaScript", "Web APIs"],
    timeline: "Hobby",
    role: "Developer",
  },
  {
    id: "unsplash-infinite-scroller",
    title: "Unsplash Infinite Scroller",
    category: ["hobby", "github", "website"],
    tags: ["API", "React", "Infinite Scroll"],
    description: "An image gallery application that fetches high-quality photos from the Unsplash API and implements infinite scrolling for a seamless viewing experience.",
    shortDescription: "Never-ending photos of cats (and other things)! Want to scroll forever?",
    image: "/placeholder.svg",
    bgColor: "bg-[#111]",
    websiteUrl: "https://devshrimali.github.io/Unsplash-Infinite-Scroller/",
    githubUrl: "https://github.com/DevShrimali/Unsplash-Infinite-Scroller",
    challenge: "To effectively manage API requests and DOM elements for high performance during continuous scrolling.",
    solution: "Implemented efficient data fetching and rendering techniques to handle large lists of images smoothly.",
    tools: ["React", "Unsplash API"],
    timeline: "Hobby",
    role: "Developer",
  },
  {
    id: "face-recognition-brain",
    title: "Face Recognition Brain",
    category: ["hobby", "github", "website"],
    tags: ["AI", "Face Detection", "React"],
    description: "A smart application that detects faces in any image provided via URL URL, utilizing machine learning models to identify and highlight human faces.",
    shortDescription: "I can see you! Well, my code can. Want to test face detection?",
    image: "/placeholder.svg",
    bgColor: "bg-[#0B1525]",
    websiteUrl: "https://devshrimali.github.io/facerecognitionbrain/",
    githubUrl: "https://github.com/DevShrimali/facerecognitionbrain",
    challenge: "To integrate a machine learning API for real-time image processing in a frontend application.",
    solution: "Used the Clarifai API to analyze images coordinates and overlay bounding boxes on detected faces.",
    tools: ["React", "Clarifai API", "Node.js"],
    timeline: "Hobby",
  ...
  },
  {
    ...
    title: "Joke Teller",
    category: ["hobby", "github", "website"],
    tags: ["Speech Synthesis", "API", "Fun"],
    description: "Entertaining web application that tells jokes using the browser's native text-to-speech API, combining humor with interactive web technologies.",
    shortDescription: "Need a laugh? Let my robot friend tell you a terrible joke!",
    image: "/placeholder.svg",
    bgColor: "bg-[#1e1e1e]",
    websiteUrl: "https://devshrimali.github.io/Joke-Teller/",
    githubUrl: "https://github.com/DevShrimali/Joke-Teller",
    challenge: "To synchronize fetched joke content with speech synthesis in a natural way.",
    solution: "Fetched jokes from a Joke API and passed them to the Web Speech API for audio output.",
