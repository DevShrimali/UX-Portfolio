...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A comprehensive travel solution for booking flights, hotels, and trains designed to simplify the complex ecosystem of travel planning.",
    image: "/travel-app.png",
    bgColor: "bg-[#0F172A]",
    behanceUrl: "https://www.behance.net/gallery/224831885/All-in-One-Travel-Booking-App",
    challenge: "Integrating multiple booking verticals (Flights, Hotels, Trains) into a single, cohesive, and clutter-free mobile experience.",
    solution: "Developed a unified search and booking flow with clear segmentations, simplified data entry, and personalized recommendations.",
    results: ["Streamlined booking process", "Reduced user drop-off", "Interactive itinerary management"],
